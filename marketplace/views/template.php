...
if(!empty($_SERVER['HTTPS']) && ('on' == $_SERVER['HTTPS'])){
	...
	if(!empty(array_filter($routesArray)[3])){
		...
		$urlGet = explode("?", array_filter($routesArray)[3]);
...
<head>
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=ASM95901jJZCYLqQZ8bUKMbpvtIwr3jQVZ79LhzczRc8xFRaoYEqsIoDnYKgpLD450XjfkxB1Sx8eaxv"></script>
